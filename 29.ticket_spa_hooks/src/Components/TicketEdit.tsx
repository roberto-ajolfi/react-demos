            ...
            <Row className="form-group">
              ...
              <Col className="col-4">
                <select className="form-control" name="state" 
                    value={state} onChange={(e: any) => setState(e.target.value)}>
...
// class TicketEditOld extends Component<RouteComponentProps<{ id: string }>, TicketEditState> {
